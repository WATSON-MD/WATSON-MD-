...
smd({
  ...
  try {
    ...
    let _0x20f704 = _0x44d3dd[1] && _0x44d3dd[1] !== "" ? _0x44d3dd[1] : "WATSON-XD";
...
smd({
  ...
  try {
    ...
    if (!_0xd51ec) {
      return _0x4cfc4e.reply("*_Example : " + prefix + "fliptext WATSON-XD!_*");
    }
