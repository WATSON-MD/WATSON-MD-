...
smd(
  {
    pattern: "channel",
    type: "misc",
    info: "WATSON-MD Support Channels",
  },
  async (_0x5ce955) => {
    try {
      let _0x1a71d9 = "https://whatsapp.com/channel/0029VajjzuB9sBI890YffB1b";
      let _0x162ed5 =
        "*_https://chat.whatsapp.com/E0a2bl9wHYlCHuL35WBR88_*\n*_JOIN WHATSAPP GROUP TO GET UPDATES._*\n\n\n*_https://youtube.com/SuhailTechInfo !_*\n*_WATCH HELPFULL VIDEO TUTORIALS ABOUT WHATSAPP BOTS FROM YOUTUBE ♥._*\n";
      let _0x39b0a0 = await _0x5ce955.bot.contextInfo(
        "WATSON-MD",
        "Hello " + _0x5ce955.senderName,
        await smdBuffer("https://i.postimg.cc/NfTgXrKh/IMG-20240808-WA0006.jpg"),
        1,
        _0x1a71d9,
        3
      );
