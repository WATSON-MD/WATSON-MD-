  ...
  async (_0x5cb388, _0x302ad5) => {
    try {
      try {
        ...
        if (!_0x557719) {
          return man.reply("Provide me a query ex Who is watson");
        }
...
cmd(
  ...
  async (_0x4e4351) => {
    try {
      ...
      await _0x4e4351.send(util.format(_0x536aa6), {}, "Watson", _0x680da4);
    } catch (_0x2ee8cc) {
...
cmd(
  ...
  async (_0xbda24) => {
    try {
      ...
      await _0xbda24.send(util.format(_0x3e1ea8.url), {}, "watson", _0x7d6de1);
    } catch (_0x1a2f02) {
...
smd(
  ...
  async (_0x45da98) => {
    try {
      ...
      let _0x1c73f9 = (
        "\nWATSON-MD A simple Mutil Device WhatsApp Bot with rich library Created and Managed by *" +
        Config.ownername +
        "*. 👑\n\n  *❲❒❳ Stars:* " +
